    ...
    <SafeAreaProvider>
      ...
      <ScrollView>
        ...
        <View style={{ padding: spacing.lg, rowGap: spacing.lg, paddingBottom: spacing.xxl }}>
          ...
          <Text>
            Export Expert Indonesia is an information, education and solution platform for
            entrepreneurs who want to transform into exporters We come with the spirit of "Let's be
            EXPERTS, Let's Export!!", inviting you to explore global opportunities and achieve
            success together through the expertise of our Export Expert team.
          </Text>
          <View style={{ rowGap: spacing.md }}>
            <Image source={logoText} style={{ width: 150, height: 40 }} />
            <View style={{ rowGap: spacing.sm }}>
              <Text weight="bold" size="lg" style={{ color: colors.main }}>
                Contact
              </Text>

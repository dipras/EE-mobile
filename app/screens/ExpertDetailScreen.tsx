...
export const ExpertDetailScreen: FC<ExpertDetailScreenProps> = observer(function ExpertDetail(
  _props,
) {
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text size="xs" style={{ color: "#878787" }}>
                {data.experience}
              </Text>
              <View
                style={{
                  flexDirection: "row",
                  gap: 5,
                  display: data.is_recommended ? "flex" : "none",
                }}
              >
